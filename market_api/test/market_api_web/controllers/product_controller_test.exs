defmodule MarketApiWeb.ProductControllerTest do
  use MarketApiWeb.ConnCase

  alias MarketApi.API
  alias MarketApi.API.Product

  @create_attrs %{barcode: "some barcode", image: "some image", name: "some name", price: "120.5"}
  ...
  def fixture(:product) do
    {:ok, product} = API.create_product(@create_attrs)
    product
  end
